...
namespace WebApplicationTests.Migrations
{
    ...
    [Migration("20211112160457_Testik")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplicationTests.Models.AboutYou", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ActivityProfile")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CompanyGoals")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApplicationTests.Models.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApplicationTests.Models.TicketMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApplicationTests.Models.TicketMessage", b =>
                {
                    b.HasOne("WebApplicationTests.Models.SupportTicket", "SupportTicket")
                        .WithMany("TicketMessages")
                        .HasForeignKey("SupportTicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplicationTests.Models.User", "User")
                        .WithMany()
